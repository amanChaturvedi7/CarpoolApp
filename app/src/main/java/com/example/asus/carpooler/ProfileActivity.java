...
public class ProfileActivity extends AppCompatActivity {
    ...
    private EditText displayNameEditText, phoneNumberEditText, rollNumberEditText;
    ...
    private void saveUserInformation() {
        ...
        if (phoneNumber.isEmpty()) {
            phoneNumberEditText.setError("Contact Number is required");
            phoneNumberEditText.requestFocus();
            return;
        }

        if (rollNumber.isEmpty()) {
            rollNumberEditText.setError("Contact Number is required");
